...
const experienceData = [
  {
    ...
    description: [
      'Developer of two production platforms serving 4,000+ clients, owning architecture, development, CI/CD, and infrastructure end to end.',
      'Built a Workforce Management System — an Electron-based attendance and productivity engine with offline-first sync, automated task verification, and scheduled reporting.',
      'Built a CRM managing 4,000+ client records — client journeys, communication timelines, follow-up queues, and AI-assisted call analysis.',
      'Connected both systems directly, so employee records and follow-up tasks sync automatically between them.',
      'Solo-owned infrastructure: GitHub Actions CI/CD to a self-managed Ubuntu VPS, RBAC, JWT-secured endpoints, and cross-system automation via n8n and Pabbly Connect.'
    ]
  },
  {
    type: 'professional',
